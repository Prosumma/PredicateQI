...
public func between<L, R>(_ lhs: L, _ rhs: (R, R)) -> PredicateBuilder
  where L: Expression & TypeComparable,
        ...
        L.PQIComparisonType == R.PQIComparisonType
{
  return compare(lhs, .between, NSExpression(forAggregate: [rhs.0.pqiExpression, rhs.1.pqiExpression]))
}
...
public func between<L, R>(_ lhs: L, _ rhs: ClosedRange<R>) -> PredicateBuilder
  where L: Expression & TypeComparable,
        ...
        L.PQIComparisonType == R.PQIComparisonType
{
  return compare(lhs, .between, NSExpression(forAggregate: [rhs.lowerBound.pqiExpression, rhs.upperBound.pqiExpression]))
}
